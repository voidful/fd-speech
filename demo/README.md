# FDSpeech demo bundle

A self-contained, anonymized demo for the four-step FDSpeech model. It packages:
...
- the compact 3-target FDSpeech LoRA adapter under `model/`
...
| System | Steps | FT | FD loss | Upstream WER | UTMOS / DNSMOS OVRL / P808 |
|---|---:|:---:|:---:|---:|---:|
...
| FDSpeech | 4 | Yes | Yes | 167/11805 = 1.4147% | 3.7637 / 3.0711 / 3.6507 |
| ARCHI-TTS reported | 32 | – | – | 1.47% | – |

## Compact 3-target FDSpeech

The compact target set keeps only content-centered FD targets:
...
10-step models, matched 4-step fine-tuning without the FD loss, FDSpeech, and three
...
Negative Cases tab surfaces rows where FDSpeech still makes a word-level ASR
...
FD-loss queue state are excluded.
